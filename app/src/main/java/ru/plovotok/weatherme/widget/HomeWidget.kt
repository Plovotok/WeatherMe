...
////        )
//        views.setOnClickPendingIntent(R.id.refresh_button, WidgetUtils().requestWidgetUpdatePendingIntent(context, true))
//
//        views.setTextViewText(R.id.appwidget_temp_text, temp)
//        views.setTextViewText(R.id.appwidget_location, location)
//
//        views.setImageViewResource(R.id.appwidget_cond_icon, screenWeather.iconResource)
////        views.
//
